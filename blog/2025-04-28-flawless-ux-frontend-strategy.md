...
tags: [UX]
keywords: [UX, 사용자 경험, 프론트엔드 에러처리, suspensive]
comments: true
---
...
**사용자는 서비스의 내부 구조를 알지 못하기 때문에, 작은 오류 하나도 전체 시스템에 대한 신뢰 상실로 이어지기 쉽습니다.**
...
기획자와 디자이너는 매우 똑똑하고 유능하지만 사용자 흐름과 화면 설계에 집중하기 때문에,
...
"사용자가 수용할 수 있는 에러 메시지를 안내해야 합니다."
