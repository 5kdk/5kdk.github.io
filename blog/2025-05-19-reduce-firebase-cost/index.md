...
authors: 5kdk
description: 예상치 못한 Firebase 요금 폭탄을 계기로, 숨은 비용 원인을 찾아내고 90% 이상 절감한 실제 개선 과정을 공유합니다.
...
이 문제를 계기로 **새로 작성한 코드부터 레거시 코드까지 전수 점검**했고, 결과적으로 현재까지 Firebase 비용을 **80% 이상 절감**할 수 있었습니다.
...
| 항목                | 최적화 전 ( 개편 전 )        | 최적화 후     |
| ------------------- | ---------------------------- | ------------- |
| 일일 읽기 호출 수   | 약 1억 2000만 회 (8,000만회) | 약 2,000만 회 |
| 일일 Firestore 요금 | 약 ￦ 120,000 (￦ 80,000)    | 약 ￦ 20,000  |

**읽기 호출 수가 6의 1 수준으로 줄면서, 비용도 자연스럽게 크게 절감**된 것을 확인할 수 있었습니다.
